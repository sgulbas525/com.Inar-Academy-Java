		...
		if (status == 0) {
			...
			if(income <= 16700)
				...
				tax = 16700 * 0.10 + (income - 16700) * 0.15;
                                ...
                                tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (income - 137050) * 0.283;
                        else if(income <= 372950)
			...
			if (income <= 8350)
                                ...
                                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (income - 186475) * 0.35;
